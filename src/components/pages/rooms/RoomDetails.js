...
import { Get_Rooms_Details } from "../../../api/global/Global";
...
const RoomDetails = () => {
  ...
  // 🔹 STATIC ROOM IMAGES (UI ONLY)
const roomImages = [
  "https://images.unsplash.com/photo-1611892440504-42a792e24d32",
  "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b",
  "https://images.unsplash.com/photo-1560067174-8949b5a43f62",
  ...
  >
    {roomImages.map((img, index) => (
      <SwiperSlide key={index}>
        <img src={img} alt="Room" className="room-main-image" />
      </SwiperSlide>
    ))}
  </Swiper>
